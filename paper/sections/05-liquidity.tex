...
The middle term has a closed form on the constant-product invariant. \citet{MilionisMoallemiRoughgarden2023Myersonian} give the instantaneous loss-versus-rebalancing rate as one eighth of the price's variance rate times pool value, which integrates across a day into realised variance over eight,
\begin{equation}
