...
Table~\ref{tab:app:v4-origin-timing} separates actions by incumbent and first-active transaction origins. Table~\ref{tab:v4-flash-gap-flow} reports the vehicle-token flow outcomes that accompany the V4 stock, action, and range estimates in Table~\ref{tab:v4-flash-gap}. Tables~\ref{tab:v3-v4-lp-protocol}, \ref{tab:v3-v4-lp-flow-protocol}, and \ref{tab:v3-v4-tvl-protocol} report every horizon and outcome underlying the main-text protocol comparison. These estimates retain the same vehicle-date comparison and observational interpretation as Equation~\eqref{eq:v3-v4-protocol-contrast}.
