...
Table~\ref{tab:lp-behavior-regressions} extends the description to provider activity. We use the outcomes to locate adjustment and keep them supplementary because demand and capital respond to common shocks.
