...
Table~\ref{tab:app:route-validation} validates route construction against Ethereum logs for 206 venue-days on 74 dates.
...
We use the following estimates to interpret the main results: entry-activity restrictions, the future-persistence version of bridge support, the composition of capital growth before first use, and relative-price risk. Pool states and first-use dates are equilibrium outcomes; the estimates describe how route use and liquidity line up.
...
Table~\ref{tab:bridge-pool-margins} separates newly active pools from capital growth in pools already supporting the route. Newly active pools hold \BridgePoolMarginNewCapitalShare{} of stablecoin weak-leg capital on the first-use day; \BridgePoolMarginContinuingCapitalShare{} lies in pools active one week earlier. Most of the increase therefore occurs in pools already active one week earlier, with a smaller pool-activation margin.
...
Table~\ref{tab:app:contestable-vehicle-choice} reports the complete set of established-pair route-choice specifications underlying Table~\ref{tab:capital-price-transmission}, panel A. Table~\ref{tab:app:price-rank-crossing} reports event-time route shares and the complete crossing regressions underlying panel B.
