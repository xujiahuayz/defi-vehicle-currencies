...
ETH stress affects three distinct objects: external liquidity flows, the dollar capital in a fixed set of pools, and route-specific weak-leg capital. Table~\ref{tab:app:eth-stress-supply-transmission} relates the first and third objects to executable output and route use. Table~\ref{tab:app:eth-decline-v2-accounting} decomposes the second into the $\sqrt{k}$ and unit-value components.
