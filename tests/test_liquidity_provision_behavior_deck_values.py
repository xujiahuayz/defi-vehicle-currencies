...
def test_liquidity_behavior_values_render_from_guarded_rows() -> None:
    rows = [
        ...
        },
        {
            ...
            "coefficient": 2.20,
            "standard_error": 0.30,
            "coefficient_per_10pp_gap": 0.220,
        ...
        },
        {
            ...
            "coefficient": -2.00,
            "standard_error": 0.30,
            "coefficient_per_10pp_gap": -0.200,
            "standard_error_per_10pp_gap": 0.030,
            "p_value": 0.001,
        },
        {
    ...
    rows.extend(
        [
            ...
            },
            {
                ...
                "coefficient": 3.00,
                "standard_error": 0.20,
                "coefficient_per_10pp_gap": 0.300,
                "standard_error_per_10pp_gap": 0.020,
                "p_value": 0.001,
                "n_observations": 2_000,
            },
            ...
            },
            {
                ...
                "coefficient": 0.50,
                "standard_error": 0.05,
                "coefficient_per_10pp_gap": 0.050,
                "standard_error_per_10pp_gap": 0.005,
                "p_value": 0.001,
                "n_observations": 2_000,
            },
            ...
            },
            {
                ...
                "coefficient": 4.00,
                "standard_error": 0.20,
                "coefficient_per_10pp_gap": 0.400,
                "standard_error_per_10pp_gap": 0.020,
                "p_value": 0.001,
                "n_observations": 2_000,
            },
            {
                ...
                "coefficient": 1.00,
                "standard_error": 0.10,
                "coefficient_per_10pp_gap": 0.100,
                "standard_error_per_10pp_gap": 0.010,
                "p_value": 0.001,
                "n_observations": 2_000,
            },
    ...
    assert "\\LiqBehStableCapitalRankLongCoef" in rendered
    assert "\\LiqBehStableRouteRankLongCoef" in rendered
    ...
    assert "\\LiqBehStableVFourActivityLongCoef" in rendered
    assert "\\LiqBehStableVFourSenderLongCoef" in rendered
    assert "\\LiqBehStableVFourActiveActivityLongCoef" in rendered
    assert "\\LiqBehStableVFourFlashNettingCoef" in rendered
    assert "\\LiqBehStableVFourFlowGrossLongCoef" in rendered
    assert "\\LiqBehStableVFourFlowRemoveLongCoef" in rendered
