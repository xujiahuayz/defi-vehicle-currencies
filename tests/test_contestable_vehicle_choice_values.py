...
def _estimate_rows() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "coefficient_pp": 10.500,
            "standard_error_pp": 0.700,
            "observations": 17_778,
        },
        {
            "record_type": "contestable_vehicle_choice_regression",
...
def test_contestable_choice_values_render_decisive_macros() -> None:
    ...
    expected = (
        ...
        r"\newcommand{\ContestSameSampleOutputAdvantageHundredBpEffect}{$+10.50$ pp}",
        r"\newcommand{\ContestSameSampleOutputAdvantageHundredBpSE}{$0.70$ pp}",
        r"\newcommand{\ContestSameSampleOutputAdvantageHundredBpN}{17{,}778}",
