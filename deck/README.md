...
The deck may stage a poll, reveal, screenshot, recording, diagram, or selected paper table when it improves a live explanation. Its scientific numbers remain downstream of the same released findings as the paper. Top-finance conference decks set the field register and information density; the reusable academic-deck rules live in [`../docs/research-workflow.md`](../docs/research-workflow.md).
