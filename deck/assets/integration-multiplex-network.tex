...
% EVIDENCE-SOURCES: README.md (integration and route-class semantics);
% docs/specifications/confirmatory.json (vehicle_transition).
% Venue names and route classes are generic; the diagram carries no adoption or causal interpretation.
\tikzset{asset/.style={circle,draw=ink,fill=white,minimum size=19pt,inner sep=0pt,font=\scriptsize}}
\tikzset{venue/.style={rounded corners=4pt,draw=rule,fill=panel,minimum width=4.55cm,minimum height=1.36cm}}
\tikzset{routecard/.style={rounded corners=3pt,draw=rule,fill=white,minimum width=4.15cm,minimum height=1.08cm}}
\tikzset{faintpath/.style={-{Stealth[length=4pt]},draw=muted,line width=0.85pt}}
\tikzset{chosenpath/.style={-{Stealth[length=4pt]},draw=ucldark,line width=1.5pt}}
