...
% Balance-sheet view: ownership rights and token holdings are different objects.
\node[font=\small\bfseries,text=ucldark,anchor=west] at (0.0,3.18) {Pool state at time $t$};
\node[callout,minimum width=2.05cm] (lp) at (0.90,2.48) {LP positions\\or receipts};
...
\node[callout,minimum width=3.40cm,anchor=north] at (2.18,-0.24)
  {deposited capital: independently valued holdings\\or ownership rights};
...
\node[callout,draw=stable,anchor=north,minimum width=3.25cm] at (8.46,-0.02)
  {executable depth: quantity available\\within a price-impact band};
