...
% docs/research-workflow.md (capital, inventory, depth, and quote semantics).
% The generic price-response curve deliberately avoids imposing one AMM invariant.
\begin{tikzpicture}[x=1cm,y=1cm,
  callout/.style={rounded corners=2pt,draw=rule,fill=panel,inner sep=5pt,align=center,font=\scriptsize},
  poolbin/.style={rounded corners=3pt,draw=ucldark,line width=1.1pt,fill=white,minimum width=2.10cm,minimum height=1.18cm,align=center},
  guide/.style={draw=muted,densely dashed,line width=0.8pt}]
...
\node[poolbin] (x) at (0.95,0.95) {$x_t$ units\\of token $X$};
\node[poolbin] (y) at (3.42,0.95) {$y_t$ units\\of token $Y$};
...
\path[fill=stable,opacity=0.12]
  (7.12,0.48) -- (7.12,0.87)
  .. controls (8.30,1.00) and (9.08,1.34) .. (9.92,1.76)
  -- (9.92,0.48) -- cycle;
