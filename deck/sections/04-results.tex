...
\end{center}
\vspace{-0.18cm}
{\scriptsize\color{muted}Annual shares of observed vehicle routes. The 2026 observation covers January--June; Other combines imported, liquid-staking, and residual assets.}
\end{frame}
...
\end{center}
\vspace{-0.11cm}
{\fontsize{7.0}{7.7}\selectfont USDT crosses parity by routed value and extends its count advantage; USDC changes little.}
\vspace{0.07cm}
...
\vspace{0.02cm}
{\fontsize{6.2}{6.8}\selectfont\color{muted}Route-count accounting for ordered endpoint pairs in 2024 and January--June 2026. Matched markets hold the ordered endpoint pair, calendar date, and single- versus cross-venue route category fixed. Dollar weighting requires source, intermediary, and destination values to agree within 20\%.}
\end{frame}
