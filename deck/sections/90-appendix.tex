...
\centering
\resizebox{0.965\textwidth}{!}{\input{assets/backing-regime-heatmap.tex}}\par
\vspace{0.08cm}
{\small We classify each asset using the backing regime in place on the route date.\par}
\end{frame}
