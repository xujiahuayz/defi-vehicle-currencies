...
\begin{columns}[T]
\begin{column}{0.47\textwidth}
\textbf{Deposited capital}\par Funds committed to a pool; on-chain balances or independently audited TVL.
\vspace{0.45cm}
...
\end{columns}
\vspace{0.65cm}
{\small We measure capital with TVL and execution depth from the pool's pricing function.\par}
\end{frame}
