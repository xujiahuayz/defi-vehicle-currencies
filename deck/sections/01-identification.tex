...
% LIVE-COMPANIONS: output/live/route_replay.html; output/live/route_replay.mp4
...
\begin{frame}{One transaction reveals cross-venue vehicle use}
...
{\small USDT is observed in the middle of this route. Whether the chosen route beat a direct alternative requires the exact pre-trade opportunity set and is not inferred from this transaction trace.\par}
\end{beamercolorbox}
\end{frame}
