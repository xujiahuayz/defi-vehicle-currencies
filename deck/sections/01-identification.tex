...
\vspace{0.06cm}
\centering
\fcolorbox{rule}{white}{\includegraphics[width=0.96\linewidth,height=1.18cm,keepaspectratio,trim=270 820 430 170,clip]{assets/observed_route_blockscout.png}}
\par\vspace{0.10cm}
\fcolorbox{rule}{white}{\includegraphics[width=0.96\linewidth,height=1.18cm,keepaspectratio,trim=280 415 324 615,clip]{assets/observed_route_blockscout.png}}
\par\vspace{0.10cm}
\fcolorbox{rule}{white}{\includegraphics[width=0.96\linewidth,height=1.18cm,keepaspectratio,trim=280 320 324 700,clip]{assets/observed_route_blockscout.png}}
\end{column}
\begin{column}{0.31\textwidth}
\evidencekicker{What reaches the pools}
\vspace{0.08cm}
\centering
\begin{tikzpicture}[x=1cm,y=1cm]
\node[softbox,inner sep=5pt,text width=2.55cm,minimum height=0.68cm,align=center] (instruction) at (2.10,4.18) {\scriptsize\bfseries User instruction\\[-0.02cm]\scriptsize PYUSD $\rightarrow$ USDe};
\node[softbox,inner sep=5pt,text width=2.55cm,minimum height=0.68cm,align=center] (maker) at (2.10,2.68) {\scriptsize\bfseries Settlement handoff\\[-0.02cm]\scriptsize PYUSD reaches the maker};
\node[softbox,inner sep=5pt,draw=stable,text width=2.55cm,minimum height=0.68cm,align=center] (fluid) at (2.10,1.18) {\scriptsize\bfseries Pool-route source\\[-0.02cm]\scriptsize USDC enters Fluid};
\draw[route,draw=ucldark,line width=1.5pt] (instruction)--(maker);
\draw[route,draw=stable,line width=1.5pt] (maker)--node[right,font=\scriptsize\bfseries,text=stable]{USDC}(fluid);
\end{tikzpicture}
\end{column}
\end{columns}
\vspace{0.08cm}
{\small The explorer reports the PYUSD--USDe instruction. The ordered transfers show that the maker supplies the USDC used by the Fluid leg.\par}
