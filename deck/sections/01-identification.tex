...
% SCIENTIFIC-BOUNDARY: the clearing example motivates allocation across bilateral trading relationships only; it is not an identification event and the paper measures DEX pool routes rather than trade settlement.
