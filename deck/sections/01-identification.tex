...
\begin{frame}{The pool route continues through USDT}
\centering
\vspace{-0.05cm}
{\small\color{muted}Full transaction path: PYUSD settlement $\longrightarrow$ \textbf{USDC $\longrightarrow$ USDT $\longrightarrow$ USDe}\par}
\vspace{0.20cm}
\begin{tikzpicture}[x=1cm,y=1cm]
