...
\vspace{0.10cm}
{\large A dollar share can fall even if old dollar corridors stay dollar-settled.\par}
\vspace{0.22cm}
{\small Growth in a non-dollar corridor changes the aggregate denominator. That is a route-allocation margin, not only a within-pair substitution margin.\par}
\end{column}
\begin{column}{0.48\textwidth}
\centering
...
\node[softbox,text width=5.15cm,align=center] at (2.50,1.15) {\small A growing direct clearing corridor can reduce aggregate dollar dominance without proving old users switched.};
