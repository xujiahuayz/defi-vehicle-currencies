...
| `render_vehicle_dominance_timelapse.py` | 18-second H.264 vehicle contest and sparse final-month poster; route-count share, supported-value share, and active pair breadth evolve from 2020 to 2026 |
...
bubble area records active directed pairs, and fading trails retain only
