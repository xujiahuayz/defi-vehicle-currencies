...
# Rounded down from the 95th percentile of realised input-to-reserve ratios.
...
def write_v4_support() -> None:
    ...
    write_exhibit(
        ...
        V4_OUT,
        code_sources=[
            "scripts/process/measure_quoter_support.py",
...
def main() -> int:
    ...
    write_exhibit(
        ...
        OUT,
        code_sources=["scripts/process/measure_quoter_support.py"],
        inputs=[RAW],
    )
