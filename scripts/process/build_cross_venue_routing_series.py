...
Run     ./scripts/run scripts/process/build_cross_venue_routing_series.py [--workers N]
...
LOCK = SHARED_RUNTIME_DIR / "cross-venue-routing.lock"
CODE_SOURCES = [
...
def main() -> int:
    ...
    route_release = route_partitions(COLS)
    ...
    write_panel(
        ...
        inputs=list(route_release.input_paths),
