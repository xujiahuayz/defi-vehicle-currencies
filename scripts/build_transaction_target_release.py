...
@contextmanager
def current_event_source_releases(
    v2_release: V2EventSourceRelease, v3_release: ArtifactRelease
):
    """Lease both resolved source generations through target construction."""

    with serialized_read_installs(
        (*v2_release.lineage_paths, *v3_release.lineage_paths)
    ):
