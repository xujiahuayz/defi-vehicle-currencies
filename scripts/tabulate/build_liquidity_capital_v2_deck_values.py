...
CODE_SOURCES = ["scripts/tabulate/build_liquidity_capital_v2_deck_values.py"]
...
def render_liquidity_capital_v2_deck_values(estimates: pd.DataFrame) -> str:
    ...
    lines = [
        "% Generated by scripts/tabulate/build_liquidity_capital_v2_deck_values.py; do not edit.",
