...
| `render_gas_adjusted_vehicle_consequences.py` | `gas_adjusted_vehicle_consequences.tex`, `gas_adjusted_vehicle_consequences_appendix.tex`, and generated values | compact gross/net consequence panel; held-out validation and gas bounds stay in the appendix table |
