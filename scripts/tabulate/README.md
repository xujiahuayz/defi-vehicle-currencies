...
| `render_v3_lp_provider_formation.py` | `v3_lp_provider_formation.tex/.pdf` and generated values | provider-side rotation and pool-formation table; manuscript placement pending |
