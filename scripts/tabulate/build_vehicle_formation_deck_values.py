...
HIGH_VALUE_SUPPORTED_USD = 100_000
...
def render_vehicle_formation_deck_values(estimates: pd.DataFrame) -> str:
    ...
    if not (
        float(high_value_entry_2026["stable_share"])
        > float(high_value_entry_2024["stable_share"])
        and float(high_value_entry_2026["stable_share"]) > 0.75
        and float(single_venue_entry_2026["stable_share"])
        > float(single_venue_entry_2024["stable_share"])
        and float(cross_venue_entry_2026["stable_share"])
        > float(cross_venue_entry_2024["stable_share"])
    ):
        raise ValueError("high-value and venue-scope entry splits no longer hold")
    lines = [
        ...
        f"\\newcommand{{\\FormationHighValueEntryStableShareBase}}{{{_pct(float(high_value_entry_2024['stable_share']))}}}",
        f"\\newcommand{{\\FormationHighValueEntryStableShareEnd}}{{{_pct(float(high_value_entry_2026['stable_share']))}}}",
        f"\\newcommand{{\\FormationHighValueEntryRoutesEnd}}{{{_int(high_value_entry_2026['primary_routes'])}}}",
        f"\\newcommand{{\\FormationHighValueThresholdUsd}}{{\\${_int(HIGH_VALUE_SUPPORTED_USD)}}}",
        f"\\newcommand{{\\FormationSingleVenueEntryStableShareBase}}{{{_pct(float(single_venue_entry_2024['stable_share']))}}}",
        f"\\newcommand{{\\FormationSingleVenueEntryStableShareEnd}}{{{_pct(float(single_venue_entry_2026['stable_share']))}}}",
        f"\\newcommand{{\\FormationCrossVenueEntryStableShareBase}}{{{_pct(float(cross_venue_entry_2024['stable_share']))}}}",
        f"\\newcommand{{\\FormationCrossVenueEntryStableShareEnd}}{{{_pct(float(cross_venue_entry_2026['stable_share']))}}}",
        ...
        f"\\newcommand{{\\FormationPathEntryShareThirtyCoef}}{{{_signed_pp(float(path_share_30['coefficient_per_10pp_entry_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationPathEntryShareThirtySE}}{{{_unsigned_pp(float(path_share_30['standard_error_per_10pp_entry_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationPathEntryShareOneTwentyCoef}}{{{_signed_pp(float(path_share_120['coefficient_per_10pp_entry_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationPathEntryShareOneTwentySE}}{{{_unsigned_pp(float(path_share_120['standard_error_per_10pp_entry_share']) / 10.0, 2)}}}",
        ...
        f"\\newcommand{{\\FormationNoDirectPathEntryShareOneTwentyCoef}}{{{_signed_pp(float(no_direct_path_share_120['coefficient_per_10pp_entry_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationNoDirectPathEntryShareOneTwentySE}}{{{_unsigned_pp(float(no_direct_path_share_120['standard_error_per_10pp_entry_share']) / 10.0, 2)}}}",
        ...
        f"\\newcommand{{\\FormationValuePathEntryShareThirtyCoef}}{{{_signed_pp(float(value_path_share_30['coefficient_per_10pp_entry_value_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationValuePathEntryShareThirtySE}}{{{_unsigned_pp(float(value_path_share_30['standard_error_per_10pp_entry_value_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationValuePathEntryShareOneTwentyCoef}}{{{_signed_pp(float(value_path_share_120['coefficient_per_10pp_entry_value_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationValuePathEntryShareOneTwentySE}}{{{_unsigned_pp(float(value_path_share_120['standard_error_per_10pp_entry_value_share']) / 10.0, 2)}}}",
        ...
        f"\\newcommand{{\\FormationIdentityPathThirtyCoef}}{{{_signed_pp(float(identity_path_30['coefficient_per_10pp_entry_candidate_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationIdentityPathThirtySE}}{{{_unsigned_pp(float(identity_path_30['standard_error_per_10pp_entry_candidate_share']) / 10.0, 3)}}}",
        f"\\newcommand{{\\FormationIdentityPathOneTwentyCoef}}{{{_signed_pp(float(identity_path_120['coefficient_per_10pp_entry_candidate_share']) / 10.0, 2)}}}",
        f"\\newcommand{{\\FormationIdentityPathOneTwentySE}}{{{_unsigned_pp(float(identity_path_120['standard_error_per_10pp_entry_candidate_share']) / 10.0, 2)}}}",
