...
def main() -> int:
    ...
    state_release = state_partitions("multi_asset", "curve", MULTI_ASSET_COLUMNS)
    ...
    write_exhibit(
        ...
        notes=f"held-out Curve quote errors with upper-tail and signed-overquote diagnostics; released-state identity {state_release.label}",
