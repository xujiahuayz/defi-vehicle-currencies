...
`scripts/verify/measure_prose_conventions.py` compares the draft against the published corpus on a
...
def formally_defined(term: str) -> bool:
    ...
    # validated "verdict" as a defined term of art when it appears in none of the 54 domain
