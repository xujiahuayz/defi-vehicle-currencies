...
ROUTES = {
    ...
    "prose": "Read workflow sections 1, 6, and 7 plus the stored JFE optics cards. Vocabulary lint is diagnostic; revision operates on the economic argument and whole paragraph sequence.",
}
