#!/usr/bin/env python3
"""Build a local progressive replay and shared manifest for one real route."""
...
def main() -> int:
    ...
    write_route_replay_bundle(manifest, manifest_path=args.manifest, html_path=args.html)
    print(f"wrote {args.manifest} and {args.html}")
    return 0
