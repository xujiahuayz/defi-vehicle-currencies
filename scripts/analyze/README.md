...
| `run_lp_stable_demand_stress.py` | week-t ETH volatility and decline against week-(t+1) stablecoin-minus-WETH LP additions, withdrawals, and net supply in the retained V2/V3 weekly panels; $50k pools, endpoint-week and pool effects, pool/week clustering, and separate four-test Holm families |
