...
| `run_eth_intraday_executable_route_chain.py` | 10% six-hour ETH-decline crossings against exact pre-transaction Uniswap v2 and SushiSwap v2 stablecoin-versus-WETH output and realised route choice; quotes use the observed notional and an independently timed Coinbase minute price series |
