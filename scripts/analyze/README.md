...
| `run_eth_intraday_executable_route_chain.py` | exact Uniswap v2 and SushiSwap v2 stablecoin-versus-WETH quotes and realised vehicle use around strictly available 0.10-log-point six-hour ETH-decline events; uses an independently timed Coinbase minute series, nonvehicle endpoints, both-family feasibility, event-by-pair and relative-hour effects, and event/pair clustered inference |
