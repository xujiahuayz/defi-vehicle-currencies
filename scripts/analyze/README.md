...
| `run_stablecoin_supply_lp.py` | lagged stablecoin-token supply growth versus later stable-core and stable-spoke capital growth and first material links; worldwide supply is primary, Ethereum supply is a local sensitivity, and the four primary core/spoke tests use Holm adjustment |
