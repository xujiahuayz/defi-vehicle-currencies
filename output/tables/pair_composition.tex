...
\addlinespace
\multicolumn{3}{l}{\emph{Panel B. Route-count share: continuing and year-specific endpoint pairs}} \\
...
Total route-count change & $+25.7$ & \\
\addlinespace
\multicolumn{3}{l}{\emph{Panel C. Dollar-weighted share: continuing and year-specific endpoint pairs}} \\
...
\addlinespace
\multicolumn{3}{l}{\emph{Panel D. Matched ordered endpoint-pair estimates}} \\
\midrule
