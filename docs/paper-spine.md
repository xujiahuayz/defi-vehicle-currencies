...
| Studying one venue becomes progressively wrong across the sample | `docs/router-identification-feasibility.md` clean-route cross-venue series, 1.4% to 60.6% count-weighted while economic multi-leg incidence stays broadly flat; the balanced five-venue perimeter still rises 19.1% to 43.6% from 2022 to 2026, while value is nearly flat after 2024 | EXISTS | Partly |
