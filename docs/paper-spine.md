...
| Studying one venue becomes progressively wrong while indirect routing contracts | `docs/router-identification-feasibility.md` clean canonical-endpoint series: cross-venue share rises 1.4% to 58.7% count-weighted; inside the balanced five-venue perimeter it rises 19.1% to 43.6% from 2022 to 2026 while economic multi-leg incidence falls 19.5% to 10.3% and value is nearly flat after 2024 | EXISTS | Partly |
