...
## Replacement temporal probe: stablecoin-specific rotation, provisional

Status 2026-08-12: the full-sample level ranking below remains retired. A separate same-cell 2024-to-2026 probe now asks how WETH's quoted-output edge changes while holding fixed the comparator, ordered endpoints, notional, reserve hour, architecture and observed candidate breadth. The immutable provisional report has result SHA-256 `0f68ecd6faf312384ad1547d4f087b763d186259ee61ef9b16211565bc78543a`; it is not an admitted paper result until the certified transaction-state release reruns it unchanged.

Across 3,911 matched cells, the median WETH-minus-comparator change is -28.11 basis points, the minimum-support-weighted change is -57.96 basis points and 77.06% of cells move negatively. The result is concentrated in fiat-reserve stablecoin comparisons: the reference controlled estimate is -37.34 basis points against USDC and -23.40 against USDT. Deleting any single year keeps both estimates negative. Removing the largest 1% of endpoint pairs strengthens them to -89.40 and -49.04 basis points, so the pattern is not manufactured by the largest pairs. Symmetric 1% tail trimming attenuates them to -16.17 and -2.85 basis points, showing that magnitude, especially for USDT, remains tail-sensitive. DAI changes sign across admissible influence checks, while WBTC has the opposite level pattern; neither supports a universal native-asset cost advantage.

The matched-cell support is economically meaningful but selected: it covers 26.69% of candidate 2024 cells and 26.20% of candidate 2026 cells, while retaining 52.60% and 45.56% of candidate rows. The largest observed included-versus-excluded composition difference is notional in 2024 and candidate breadth in 2026. The permitted provisional reading is therefore a conditional change in WETH's cost position relative to USDC and USDT on common routing opportunities. It does not establish market-wide efficiency improvement, an aggregator effect, causality or a general stablecoin mechanism. The exact-state release must reproduce the sign and the influence envelope before this result can be promoted.
