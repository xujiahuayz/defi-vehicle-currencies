...
| 4 | Prior-information bridge formation | Existing route-share and capital panels | Event date uses only lagged information; adoption timing and continuous depth reported | Passed; main text reports at-risk extensive and intensive margins; threshold and persistent-support comparisons remain in the appendix; next-week depth bounds a one-way interpretation |
