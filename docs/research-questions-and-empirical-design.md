...
- **Disintermediation versus activation:** report economic multi-leg incidence among all clean routes separately from the intermediary composition of those routes, on both the full and balanced venue perimeters. A fall in incidence supports direct-liquidity discovery; stable-share growth conditional on remaining indirect supports activation of fragmented stable liquidity. Neither can be inferred from cross-venue growth alone.
