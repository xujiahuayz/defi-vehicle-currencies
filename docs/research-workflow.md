...
Measured on all 2,277 days after enforcing clean reconstructed routes and canonical endpoint identity: the share of economic multi-leg routes spanning more than one venue rises from **1.4% in 2020 to 58.7% in 2026** by count and from **15.4% to 89.3%** by value. Economic multi-leg incidence among economic routes falls from **19.5% in 2022 to 16.6% in 2026**, an equal-weighted daily change of -2.61 percentage points (Newey-West SE 0.47, p<0.001). Complexity changes too: routes with more than two swap legs rise from **10.3% to 38.5%**, mean legs from **2.12 to 3.23** and mean venues from **1.02 to 1.78**, with the acceleration after 2024. A balanced perimeter restricted to the same five venue families gives a smaller but still clear 2022-to-2026 cross-venue count rise from **19.1% to 43.6%**, while value moves only **49.4% to 55.5%**, routes above two legs **15.1% to 20.0%**, mean legs **2.25 to 2.39** and mean venues **1.22 to 1.47**. Within that perimeter, economic multi-leg incidence nearly halves from **19.5% to 10.3%**, a daily change of -9.02 points (SE 0.41, p<0.001), but perimeter coverage falls from 100.0% to 69.8% and entrant-touching routes have 31.3% incidence in 2026. The large balanced change is therefore a support-exit decomposition, not an efficiency estimate; only the smaller full-market contraction is admissible as a market-wide descriptive result. Swap-leg count combines sequential hops with pool splitting, so it measures route complexity and not optimisation quality. Studying one venue in isolation becomes progressively wrong, but cross-venue, incidence and complexity changes alone do not identify aggregator causality or better conditional execution.
