...
Handling: a single footnote acknowledging concurrent independent work, with no claim resting on it, and no positioning paragraph. The asymmetry favours the footnote, since a referee who knows the paper and sees no mention may read that as unawareness.
