...
9. Show that pair activity and vehicle use account for almost all of the aggregate rotation, while stable share still rises among pairs observed in both endpoint years.
