...
No. The full 44,162,040-episode split conditions directly on whether the realised coherent route stayed on one venue or crossed venues. From 2024 to 2026, the stable episode share rises from 18.6% to 41.1% on single-venue routes and from 18.9% to 43.8% on cross-venue routes; the native share falls from 75.7% to 45.6% and from 60.7% to 29.6%. The parallel movement rejects the simple composition account in which stable intermediation rises only because more transactions enter the cross-venue routing regime.

The value-weighted split is less uniform and prevents a stronger claim. In 2026, stable intermediaries carry 52.0% of single-venue value against 31.1% for native, while cross-venue value remains native-led at 44.5% against 33.5%. Integration is therefore neither irrelevant nor a complete explanation: it changes which trades and sizes use each intermediary, while the count transition survives within either integration regime. Conditional realised-to-best gaps are still required before calling the market more search-efficient.
