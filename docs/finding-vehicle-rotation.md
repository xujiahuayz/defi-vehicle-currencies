# Vehicle-currency rotation — stub

PROVISIONAL (workflow §41). Numbers are never copied here; rerun the script to refresh them.
...
Event studies around mechanism introductions (Uniswap v3 2021-05, Terra 2022-05, USDC depeg 2023-03, v4, router/aggregator releases, and the event under the sustained 2025Q1 value crossing), and powered pair/token × day FE regressions across trade-size and venue. Guarded in the script until node D publishes the daily panel.
