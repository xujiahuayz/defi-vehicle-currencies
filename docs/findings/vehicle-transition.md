...
The timing comparison separates liquidity presence from subsequent use. Stable routing begins on the support date in 9.1% of the 865 events, within 30 days in 54.3%, and within 120 days in 63.4%; the median lag among eventual adopters is eight days. Of 853 events with positive event-day stable and WETH depth, 44.2% of bridges below one tenth of WETH depth are adopted within 30 days, compared with 85.1% at or above one tenth. The equal-event difference is 40.92 percentage points (two-way-clustered SE 4.83 points, p=3.49e-14); through 120 days it remains 36.15 points (SE 4.45 points, p=2.41e-13). Controlling for log pre-event native route and value activity per active day, endpoint direction, route scope, supporting stablecoin set, and event month reduces those gaps to 24.24 points at 30 days (SE 5.65 points, p=3.37e-5) and 20.52 points at 120 days (SE 5.29 points, p=1.63e-4). Among 410 events with two non-stablecoin endpoints, the gaps remain 37.64 points at 30 days (SE 12.38 points, p=0.0033) and 38.75 points at 120 days (SE 12.01 points, p=0.0019). A continuous relative-depth specification is also positive at both horizons. Persistent bridge capital often predates stable routing, and relative depth predicts whether use follows. Because support and use are equilibrium outcomes, the timing does not identify provider-supply causality.
