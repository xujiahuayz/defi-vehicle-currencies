...
question and literature                    done
  ...
  → presentable paper/deck trunk            51/43 pages; rebuild after admitted changes
...
bounded V3 fee/rent-incidence screens, V3 mint/burn action-count responses,
local bridge-liquidity dominance, and V2 capital predictability. A
